$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
      ...
      $.getJSON("http://localhost/tutorials/simple-rest-api/api/product/read_one.php?id=" + id, function(data){
          ...
          $.getJSON("http://localhost/tutorials/simple-rest-api/api/category/read.php", function(data){
    ...
    $(document).on('submit', '#update-product-form', function(){
      ...
      $.ajax({
          url: "http://localhost/tutorials/simple-rest-api/api/product/update.php",
          type : "POST",
